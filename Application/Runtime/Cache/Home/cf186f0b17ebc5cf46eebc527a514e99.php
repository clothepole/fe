...
<!--&nbsp;<a class="btn btn-large btn-primary btn-success" href="#"  data-toggle="modal"    data-target="#myModal4"><i class="icon-plus"></i>&nbsp;&nbsp;修改&nbsp;&nbsp; </a>
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>-->
</div>
  <table id="table" class="table-striped"   data-toggle="table" data-height="350"  data-url="/public/json/data-basic-xq-ld.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
        <th data-checkbox="true"  data-field="state"></th>
        <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th>
        <th data-field="mc" data-align="center"  data-sortable="true">区域项目部名称</th>       
        <th data-field="mj" data-align="center"  data-sortable="true">区域项目部总面积（平方米）</th>    
        <th data-field="fzr" >负责人</th>
        <th data-field="lxfs" >联系方式</th>  
      </tr>
    </thead>
  </table>
  <!-- 模态框（Modal） -->
...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>-->
    ...
    <table  id="table2" class="table-striped"   data-toggle="table" data-height="350"  data-url="/public/json/data-basic-xq-ld.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
        <th data-checkbox="true"  data-field="state"></th>
        <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th>
        <th data-field="xm" data-align="center"  data-sortable="true">项目名称</th>
        <th data-field="mj" data-align="center"  data-sortable="true">总面积（平方米）</th> 
        <th data-field="fzr" >负责人</th>
        <th data-field="lxfs" >联系方式</th> 
      </tr>
    </thead>
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="jg-List-info.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
...
<div class="modal fade" id="myModal6" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="jg-List-info2.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
 <div class="modal-footer" style="width:850px; height:43px;  background-image:url(../images/title2_di.jpg);">
            <button type="button"  class="btn btn-large btn-primary"  onClick="window.close();" 
               data-dismiss="modal">提交
...
<div class="modal fade" id="myModal22" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="ld-Info-List.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
 <!--<div class="modal-footer" style="width:850px; height:43px;  background-image:url(../images/title2_di.jpg);">
            <button type="button"  class="btn btn-large btn-primary"  onClick="window.close();" 
               data-dismiss="modal">提交
...
function operateFormatter(value, row, index) {
        return [
            ...
            '</a >&nbsp;&nbsp;&nbsp;&nbsp;',
            '<a class="remove icon-large" href="javascript:;" title="删除">',
...
<script type="text/javascript">
    function FullInfo(){ 
   window.showModalDialog("jg2-List.html","","dialogWidth:1200px; dialogHeight:750px;dialogLeft:400px; dialogTop:200px;  scroll:no;status:no") 
   } 
