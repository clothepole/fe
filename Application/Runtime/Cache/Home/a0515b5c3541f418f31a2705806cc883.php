...
<body>
<div >
&nbsp;<a class="btn btn-large btn-primary" href="#"  data-toggle="modal"    data-target="#myModal5"><i class="icon-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp; </a>
<!-- &nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a> -->
</div> 
  <table id="table" class="table-striped"   data-toggle="table" data-height="400"  data-url="/public/json/dd-data-basic.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
       <th data-radio="true"  data-field="state"></th>
        ...
        <th data-field="gzz" data-align="center"  data-sortable="true">工作站</th> 
        <th data-field="DTU" data-align="center"  data-sortable="true">DTU号码</th> 
        <th data-field="lb" data-align="center"  data-sortable="true">DTU类别</th> 
        <th data-field="DTUtel" data-align="center"  data-sortable="true">接收DTU电话</th>         
        <th data-field="grmj" data-align="center"  data-sortable="true">寄存器数量</th> 
      </tr>
    </thead>
  </table>
  <!-- 模态框（Modal） -->
  <div >
&nbsp;<a class="btn btn-large btn-primary" href="#"  data-toggle="modal"    data-target="#myModal6"><i class="icon-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp; </a>
<!-- &nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a> -->
</div>
    <table  id="table2" class="table-striped"   data-toggle="table" data-height="400"  data-url="/public/json/dd-1-data-basic.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true"  data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
      <th data-checkbox="true"  data-field="state"></th>
        ...
        <th data-field="gzz" data-align="center"  data-sortable="true">工作站</th> 
        <th data-field="DTU" data-align="center"  data-sortable="true">DTU号码</th> 
        <th data-field="lb" data-align="center"  data-sortable="true">PLC类别</th> 
        <th data-field="dress" data-align="center"  data-sortable="true">PLC地址</th>         
        <th data-field="grmj" data-align="center"  data-sortable="true">寄存器数量</th> 
      </tr>
    </thead>
  </table>
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div class="modal-body">
          <table  id="table2" class="table-striped"   data-toggle="table"  data-url="gzry.json"  data-page-size="15" width="100%">
            <thead  class="thead" >
              <tr>
                <th data-checkbox="true"  data-field="state"></th>
                <!-- <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th> -->
                <th data-field="DTU" data-align="center"  data-sortable="true">DTU号码</th> 
                <th data-field="dress" data-align="center"  data-sortable="true">PLC地址</th>        
                <th data-field="grmj" data-align="center"  data-sortable="true">寄存器地址</th>
                <th data-field="grmj" data-align="center"  data-sortable="true">字长</th>
                <th data-field="grmj" data-align="center"  data-sortable="true">对应项名称</th> 
                <th data-field="grmj" data-align="center"  data-sortable="true">单位</th>
                <th data-field="grmj" data-align="center"  data-sortable="true">类别</th> 
              </tr>
            </thead>
          </table>
         </div>
...
<div class="modal fade" id="myModa001" tabindex="-1" role="dialog" 
   aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         <div class="modal-header" style="width:850px; background-image:url(../images/title_di.jpg); height:43px; padding-top:4px;margin:0;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="sfqy-info.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
 <div class="modal-footer" style="width:850px; height:43px;  background-image:url(../images/title2_di.jpg);">
            <button type="button"  class="btn btn-large btn-primary"  onClick="window.close();" 
               data-dismiss="modal">提交
