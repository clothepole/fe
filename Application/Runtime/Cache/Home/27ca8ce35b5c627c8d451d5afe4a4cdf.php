    ...
    <thead  class="thead" >
      <tr>
       <th data-radio="true"  data-field="state"></th>
        ...
        <th data-field="xm" data-align="center"  data-sortable="true">项目</th> 
        <th data-field="gzz" data-align="center"  data-sortable="true">工作站</th> 
        <th data-field="zbb" data-align="center"  data-sortable="true">值班表数</th> 
        <th data-field="gxrq" data-align="center"  data-sortable="true">更新日期</th> 
        <th data-field="czry" data-align="center"  data-sortable="true">操作人员</th> 
      </tr>
    </thead>
  </table>
  <!-- 模态框（Modal） -->
...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>
    ...
    <table  id="table2" class="table-striped"   data-toggle="table" data-height="400"  data-url=""  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true"  data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
      <th data-checkbox="true"  data-field="state"></th>
<!--         <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th> -->
        <th data-field="xqmc" data-align="center"  data-sortable="true">值班表名</th>
        <th data-field="gs" data-align="center"  data-sortable="true">备注</th> 
      </tr>
    </thead>
  </table>
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div class="modal-body">
          <table  id="table2" class="table-striped"   data-toggle="table"  data-url="/public/json/gzry.json"  data-page-size="15" width="100%">
            <thead  class="thead" >
              <tr>
                <th data-checkbox="true"  data-field="state"></th>
                <!-- <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th> -->
                <th data-field="ldmc" data-align="center"  data-sortable="true">楼栋名称</th>
                <th data-field="gs" data-align="center"  data-sortable="true">所管辖用户数</th> 
              </tr>
            </thead>
          </table>
         </div>
