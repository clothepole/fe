...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>
  ...
  <table id="table" class="table-striped"   data-toggle="table" data-height="700"  data-url="/public/json/data-basic.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
      <th data-checkbox="true"  data-field="state"></th>
        ...
        <!-- <th data-field="ggxh" data-align="center"  data-sortable="true">型号</th>  -->
        <th data-field="zycs" data-align="center"  data-sortable="true">规格参数</th> 
        <th data-field="gys" data-align="center"  data-sortable="true">库存</th> 
