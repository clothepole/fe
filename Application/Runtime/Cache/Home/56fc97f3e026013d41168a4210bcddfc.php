...
<body>
<div >
&nbsp;<a class="btn btn-large btn-primary" href="#"  data-toggle="modal"    data-target=""><i class="icon-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp; </a>
...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>-->
    ...
    <thead  class="thead" >
      <tr>
        <th data-checkbox="true"  data-field="state"></th>
        <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th>
        <th data-field="sfd" data-align="center"  data-sortable="true">工作站名称</th>
        <th data-field="mj" data-align="center"  data-sortable="true">供热总面积（平方米）</th>
        <th data-field="fzr" >负责人</th>
        <th data-field="lxfs" >联系方式</th> 
      </tr>
    </thead>
...
<script type="text/javascript">
   ...
   function FullInfo1(){ 
   window.showModalDialog("jg3-1-List.html","","dialogWidth:1200px; dialogHeight:400px;dialogLeft:400px; dialogTop:200px;  scroll:no;status:no") 
   } 
