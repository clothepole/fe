...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>
  ...
  <table id="table" class="table-striped"   data-toggle="table" data-height="700"  data-url="dd-data-basic.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
     <!--  <th data-checkbox="true"  data-field="state"></th> -->
        <!-- <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  状态</th> -->
        <th data-field="zt" data-align="center"  data-sortable="true">状态</th>
