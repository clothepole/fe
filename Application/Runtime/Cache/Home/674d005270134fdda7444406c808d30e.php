     ...
     >
        <thead  class="thead" >
          <tr>
           ...
           <th data-field="hrz" >换热站</th>
           <th data-field="yj" >效率</th>
          </tr>
        </thead>
      </table>
  <!-- 模态框（Modal） -->
...
<div class="modal fade" id="myModal002" tabindex="-1" role="dialog" 
   aria-labelledby="myModalLabel" aria-hidden="true">
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:1000px;">
         <div class="modal-header" style="width:1000px; background-image:url(../images/title_di.jpg); height:43px; padding-top:4px;margin:0;">
         ...
         <div style="padding:0; width:1000px;height:528px;">
            <img src="/images/ztt.png" width="985" height="528" />
         </div>
    <div class="modal-footer" style="width:1000px; height:43px;  background-image:url(../images/title2_di.jpg);">
