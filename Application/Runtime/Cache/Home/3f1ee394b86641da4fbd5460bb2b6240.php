...
<body>
<div >
&nbsp;<a class="btn btn-large btn-primary" href="#"  data-toggle="modal"    data-target="#myModal7"><i class="icon-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp; </a>
...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>-->
  ...
  <!-- 模态框（Modal） -->
<!--&nbsp;<a class="btn btn-large btn-primary" href="#"  data-toggle="modal"    data-target="#myModal8"><i class="icon-plus"></i>&nbsp;&nbsp;新增&nbsp;&nbsp; </a>
&nbsp;<a class="btn btn-large btn-primary btn-success" href="#"  data-toggle="modal"    data-target="#myModal4"><i class="icon-plus"></i>&nbsp;&nbsp;修改&nbsp;&nbsp; </a>
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>
</div>
    <table id="table2" class="table-striped"   data-toggle="table" data-height="350"  data-url="data-basic-xq-ld.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
      <th data-checkbox="true"  data-field="state"></th>
        <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th>
        <th data-field="xqmc" data-align="center"  data-sortable="true">监测数据</th>
        <th data-field="fzr" >今日</th>
        <th data-field="lxfs" >昨日</th> 
        <th data-field="dress" >地址</th>
      </tr>
    </thead>
  </table>-->
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="zzz-info.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
