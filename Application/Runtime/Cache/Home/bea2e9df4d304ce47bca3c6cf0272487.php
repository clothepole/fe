...
<div class="row">
  <div class="col-md-12" >
    <ul class="nav nav-tabs">
      <li class="active"><a href="#add" data-toggle="tab">检修历史</a></li>
      <li class=""><a href="#nav-tab-2" data-toggle="tab">检修计划</a></li>
    </ul> 
        ...
        <div class="right-padding col-md-12 ui-sortable ">   
          <div class="row"> 
            <div class="right-padding ui-sortable">         
              ...
              <br>
            <table  id="table2" class="table-striped"   data-toggle="table" data-height="650"  data-url="/public/json/dd-data-basic.json"  data-page-size="13" data-page-list="[10,13,25,35,all]"  width="100%">
            <thead  class="thead" >
            <tr>        
             <th data-field="time" data-align="center"  data-sortable="true">时间</th>
              <th data-field="sb" data-align="center"  data-sortable="true">设备</th>
              <th data-field="sbbh" data-align="center"  data-sortable="true">设备编号</th>        
              <th data-field="gzyy" data-align="center"  data-sortable="true">故障原因</th>
              <th data-field="cljg" data-align="center"  data-sortable="true">处理结果</th>
              <th data-field="zp" data-align="center"  data-sortable="true">照片</th>
              <th data-field="xm" data-align="center"  data-sortable="true">检修人员</th>
            </tr>
            </thead>
            </table>
          </div>
        ...
        <div class="right-padding col-md-12 ui-sortable ">   
          <div class="row"> 
            <div class="right-padding ui-sortable">         
              ...
              <br>
           <table  id="table2" class="table-striped" data-toggle="table" data-height="650"  data-url="/public/json/data-basic-bg-list.json" data-page-size="13" data-page-list="[10,13,25,35,all]"  width="100%">
            <thead  class="thead" >
            <tr>        
             <th data-field="time" data-align="center"  data-sortable="true">时间</th>
              <th data-field="sb" data-align="center"  data-sortable="true">设备</th>
