...
&nbsp;<a class="btn btn-large  btn-info active"   href="#" onClick="leadingwin()"><i class=" icon-upload-alt"></i>&nbsp;&nbsp;导入&nbsp;&nbsp;</a>
  ...
  <table id="table" class="table-striped"   data-toggle="table" data-height="700"  data-url="/public/json/gzry.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      <tr>
      <th data-checkbox="true"  data-field="state"></th>
        <th data-align="center" data-formatter="operateFormatter" data-events="operateEvents">  操作</th>
        <th data-field="itemid" data-align="center"  data-sortable="true">帐号</th>
        <th data-field="xm" data-align="center"  data-sortable="true">姓名</th>
        <th data-field="tel" data-align="center"  data-sortable="true">手机</th> 
        <th data-field="parm" data-align="center"  data-sortable="true">部门</th> 
        <th data-field="gh" data-align="center"  data-sortable="true">工号</th> 
        <th data-field="zw" data-align="center"  data-sortable="true">职务</th> 
        <th data-field="js" data-align="center"  data-sortable="true">角色</th> 
        <th data-field="states" data-align="center"  data-sortable="true">状态</th> 
