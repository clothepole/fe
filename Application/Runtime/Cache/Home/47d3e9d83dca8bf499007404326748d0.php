  ...
  <table id="table" class="table-striped"   data-toggle="table" data-height="700"  data-url="/public/json/dd-data-basic.json"  data-page-size="15" data-show-columns="true"  data-jumpMenu="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-export="true" data-pagination="true" width="100%">
    <thead  class="thead" >
      ...
      <th data-checkbox="true"  data-field="state"></th>
        ...
        <th data-field="gsmc" data-align="center"  data-sortable="true">公司</th>
        <th data-field="bm" data-align="center"  data-sortable="true">部门</th>        
        <th data-field="gys" data-align="center"  data-sortable="true">姓名</th>
        <th data-field="zw" data-align="center"  data-sortable="true">职位</th> 
        <th data-field="lxfs" data-align="center"  data-sortable="true">联系方式</th> 
        <th data-field="bz" data-align="center"  data-sortable="true">备注</th> 
      </tr>
    </thead>
  </table>
   ...
   <div class="modal-dialog"  >
      <div class="modal-content"   style="width:852px;">
         ...
         <div style="padding:0; width:850px;height:280px;">
            <iframe src="wxtx-info.html" style="width:100%;height:100%;border:0; margin-top:0;"></iframe>
         </div>
